...
const ShippingCard = ({ icon: Icon, title, children }: { icon: React.ElementType; title: string; children: React.ReactNode }) => (
  <div className="border border-gold/10 rounded-xl p-6 bg-card/30 backdrop-blur-sm hover:border-gold/30 transition-colors">
    ...
    <div className="font-body text-sm text-ivory/80 leading-relaxed space-y-2">
      {children}
    </div>
  </div>
);
          ...
          <div className="space-y-8 font-body text-ivory/80 leading-relaxed text-sm">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <ShippingCard icon={Package} title="Free Shipping (India)">
                <p>Orders above <strong className="text-ivory">₹2,999</strong> qualify for <strong className="text-ivory">free standard shipping</strong> anywhere in India.</p>
                <p>For orders below ₹2,999, a flat shipping fee of ₹99 applies.</p>
              </ShippingCard>

              <ShippingCard icon={Clock} title="Delivery Timeline (India)">
                <p><strong className="text-ivory">Metro cities:</strong> 3–5 business days</p>
                <p><strong className="text-ivory">Other cities:</strong> 5–7 business days</p>
                <p><strong className="text-ivory">Remote areas:</strong> 7–10 business days</p>
              </ShippingCard>
              ...
              <ShippingCard icon={Globe} title="International Shipping">
                ...
                <p><strong className="text-ivory">Estimated delivery:</strong> 10–21 business days depending on the destination country.</p>
              </ShippingCard>
            ...
            <section>
              ...
              <p>
                All orders are processed within <strong className="text-ivory">1–3 business days</strong> (Monday–Saturday, excluding public holidays). Since each product is handcrafted, please allow a little extra time during festive seasons or high-demand periods.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                within <strong className="text-ivory">48 hours</strong> of delivery with photographs of the damage. We will work with our shipping partner to resolve the issue.
              </p>
              <p className="mt-4">
