...
const stats: StatItem[] = [
  { value: 12000, suffix: "+", label: "Garments Transformed", sublabel: "Sacred clothes given a beautiful new life", icon: "🙏" },
  { value: 850, suffix: "+", label: "Hours of Handwork", sublabel: "Real people, real hands, real craft", icon: "✋" },
  { value: 3200, suffix: " kg", label: "Cloth Saved", sublabel: "Temple textiles kept out of landfills", icon: "🧵" },
  { value: 47, suffix: "+", label: "Temple Partners", sublabel: "Including Khatushyam Delhi Dham", icon: "🕉️" },
  { value: 5000, suffix: "+", label: "Happy Customers", sublabel: "People who carry something meaningful", icon: "💛" },
  { value: 0, suffix: "%", label: "Waste", sublabel: "Every scrap finds a purpose — nothing is thrown away", icon: "♻️" },
];
...
const ImpactSection = () => {
  ...
  return (
    <section ref={ref} className="relative py-28 overflow-hidden bg-gradient-sacred">
      {/* Floating particles */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="font-body text-ivory/40 mt-4 max-w-lg mx-auto text-sm">
            Every purchase supports artisan livelihoods, saves textiles from waste, and keeps tradition alive.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="font-display text-lg md:text-xl text-ivory/50 italic">
            "Nothing is wasted. Everything finds its purpose."
          </p>
        </motion.div>
      </div>
    </section>
